...
describe('qorusDateStringToIso', () => {
  ...
  it('rejects a slash-named zone (only abbreviations match — why callers use a numeric offset)', () => {
    // The strict regex allows a 3-letter zone, not `Europe/Prague`; a value like
    // this needs a numeric offset (or the ISO `T` form) to be recognised.
